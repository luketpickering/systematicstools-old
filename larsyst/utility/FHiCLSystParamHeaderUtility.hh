...
NEW_LARSYST_EXCEPT(invalid_SystParamHeader_key);
NEW_LARSYST_EXCEPT(invalid_FHiCL_variation_descriptor);
NEW_LARSYST_EXCEPT(invalid_FHiCL_random_distribution_descriptor);
