...
#include "systematicstools/utility/scrub_unity_responses.hh"
...
private:
  systtools::provider_map_t syst_providers;
...
void lareventsyst::produce(art::Event &e) {
  ...
  systtools::scrub_unity_responses(er);
  ...
  std::cout << "[INFO]: Built response: " << systtools::to_str(*er) << std::endl;
